package org.whocares.weather.dao.impl;
...
public class CityDaoImpl implements ICityDao {
	...
	public String queryProvincesByCache() {
		BoundSetOperations<String, String> provinceBSOper = redisTemplate.boundSetOps("info.city.provinceCN");
	...
	public String queryCitysByCache(String province) {
		BoundSetOperations<String, String> cityBSOper = redisTemplate.boundSetOps("info.city.cityCN." + province);
	...
	public String queryDistrictsByCache(String province, String city) {
		BoundSetOperations<String, String> districtBSOper = redisTemplate.boundSetOps("info.city.districtCN." + province + "." + city);
